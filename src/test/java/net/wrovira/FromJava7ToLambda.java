...
public class FromJava7ToLambda {
    ...
    private static Employee[] sortByNameJava7(Employee[] employees) {
        ...
        Arrays.sort(employees, cmp);
        return employees;
    }

    private static Employee[] sortBySalaryJava7(Employee[] employees) {
        Comparator<FromJava7ToLambda.Employee> cmp = new Comparator<Employee>() {
    ...
    private static Employee[] sortByNameJava8(final Employee[] employees) {
    ...
    private static Employee[] sortBySalaryJava8(final Employee[] employees) {
